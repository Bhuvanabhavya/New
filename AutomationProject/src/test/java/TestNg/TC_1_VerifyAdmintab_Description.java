...
import TestNgScreenshot.Screenshot;

//import dev.failsafe.internal.util.Durations;

public class TC_1_VerifyAdmintab_Description extends Screenshot{
	...
	@Test(priority = 1, description = "this method is used to add some information about test")
	public void enterusername() throws IOException {
		...
		screenshotHandling("enterusername screenshot");
	}
